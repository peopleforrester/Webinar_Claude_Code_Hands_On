...
| Opus 4.8 + Sonnet 4.6 via Bedrock (200K context) | |

**Confirmed capacity**: Both Opus 4.8 and Sonnet 4.6 available via Bedrock with 200K context. No rate limit for 30 concurrent users.
