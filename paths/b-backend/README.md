...
**What you'll build:** A locally-running REST API in Node.js or Python that accepts, validates, stores, and cancels theme park reservations using in-memory data structures. Every endpoint has input validation, proper HTTP status codes, and tests.
