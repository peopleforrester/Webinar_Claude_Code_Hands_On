...
- **Independent challenge:** Open [independent-brief.md](independent-brief.md) for the self-directed challenge (Park Wait Times Display Board).
- **Skill reference:** See [skills-examples/ui-component/SKILL.md](../../skills-examples/ui-component/SKILL.md) in the repo root for an example skill file for this path.
